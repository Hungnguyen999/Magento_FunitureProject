...
return [
    'modules' => [
        ...
        'Amazon_Payment' => 1,
        'Csp_Fix' => 1,
        'CustomHomePage_CarouselCustom' => 1,
        'CustomHomePage_CarouselWidget' => 1,
        'CustomHomePage_CustomMainBanner' => 1,
        'CustomMenu_CustomFooterSocial' => 1,
        'CustomMenu_CustomLink' => 1,
        'CustomMenu_HeaderMenu' => 1,
        'CustomTab_TabDetail' => 1,
        ...
        'Phu_Priceslider' => 1,
        'SR_CategoryImage' => 1,
        'Team1_FeaturedCategory' => 1,
        'Team2BestSeller_BestsellersProducts' => 1,
        'Team2BrowseAll_OnePageProducts' => 1,
        'Team2DetailPage_CustomHTMLBlock' => 1,
        'Team2DetailPage_CustomImageBlock' => 1,
        'Team2DetailPage_Related' => 1,
        ...
        'Team2_OrderComment' => 1,
        'Team2_RewardPoint' => 1,
        'Team3Vendor_GiftwrapSlider' => 1,
        'Temando_ShippingRemover' => 1,
        'Turiknox_RewardPoints' => 1,
        'Vertex_Tax' => 1,
